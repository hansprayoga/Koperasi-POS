    ...
    <aside className="w-64 h-screen bg-[#0f172a] text-white flex flex-col shadow-xl overflow-hidden">
      ...
      <div className="flex-shrink-0 px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-bold text-sm leading-tight">CoopSystem</p>
            <p className="text-xs text-slate-400">Cooperative Management</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-2">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-400 truncate">admin@coop.org</p>
          </div>
        </div>
      </div>
    </aside>
